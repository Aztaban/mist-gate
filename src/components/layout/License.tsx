...
const License = () => {
  ...
  return (
    <section className="license page-stack">
      ...
      {/* Grant of License */}
      <article className="surface-dark section">
        <h2 className="section-title">1. Grant of License</h2>
      ...
      {/* Permitted Uses */}
      <article className="surface-dark section">
        <h2 className="section-title">2. Permitted Uses</h2>
        <ul className="license__list">
      ...
      {/* Restrictions */}
      <article className="surface-dark section">
        <h2 className="section-title">3. Restrictions</h2>
        <ul className="license__list">
      ...
      <article className="surface-dark section">
        <h2 className="section-title">4. Commercial & Classroom Use</h2>
        <p>
      ...
      {/* Returns & Access */}
      <article className="surface-dark section">
        <h2 className="section-title">5. Returns & Access</h2>
        <ul className="license__list">
          <li>
      ...
      {/* Privacy */}
      <article className="surface-dark section">
        <h2 className="section-title">8. Privacy & Data</h2>
        <p>
      ...
      {/* Contact */}
      <footer className="surface-dark section license__footer">
        <p>
